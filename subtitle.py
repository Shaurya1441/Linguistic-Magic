...
# Form implementation generated from reading ui file 'C:\Users\Shaurya Gupta\Desktop\Linguistic Magic\subtitle.ui'
#
    ...
    if current_time>=max_time:
        ...
        with sr.AudioFile(audio) as source:
            ...
            if sentence == "speech recognition is over":
                ...
                with open("Shaurya_Nikunj.srt","a") as f:
                    f.write(block_str)
                    f.write("\n")
...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1064, 863)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.label_2 = QtWidgets.QLabel(self.centralwidget)
        self.label_2.setGeometry(QtCore.QRect(10, 10, 341, 211))
        self.label_2.setText("")
        self.label_2.setPixmap(QtGui.QPixmap("3.PNG"))
        self.label_2.setObjectName("label_2")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(360, 40, 641, 171))
        font = QtGui.QFont()
...
"background-color: rgb(255, 255, 0);")
        ...
        self.label_5.setGeometry(QtCore.QRect(20, 270, 571, 31))
        font = QtGui.QFont()
        font.setFamily("Algerian")
...
"background-color: rgb(85, 255, 255);")
        ...
        self.lineEdit.setGeometry(QtCore.QRect(610, 270, 421, 31))
        self.lineEdit.setObjectName("lineEdit")
        self.pushButton = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton.setGeometry(QtCore.QRect(440, 320, 171, 31))
        font = QtGui.QFont()
        font.setFamily("Algerian")
...
"background-color: rgb(255, 0, 0);")
        ...
        self.label_6.setGeometry(QtCore.QRect(30, 370, 561, 31))
        font = QtGui.QFont()
        font.setFamily("Algerian")
        font.setPointSize(11)
        font.setBold(True)
...
"background-color: rgb(255, 255, 0);")
        ...
        self.lineEdit_2.setGeometry(QtCore.QRect(610, 370, 421, 31))
        self.lineEdit_2.setObjectName("lineEdit_2")
        self.pushButton_2 = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_2.setGeometry(QtCore.QRect(450, 420, 171, 31))
        font = QtGui.QFont()
        font.setFamily("Algerian")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.pushButton_3.setGeometry(QtCore.QRect(30, 480, 981, 31))
...
"background-color: rgb(255, 0, 0);")
        ...
        self.label_3.setGeometry(QtCore.QRect(30, 540, 971, 41))
        font = QtGui.QFont()
        font.setFamily("Algerian")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.progressBar.setGeometry(QtCore.QRect(20, 600, 1041, 51))
        font = QtGui.QFont()
        font.setFamily("Algerian")
        font.setBold(True)
        font.setWeight(75)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "SUBTITLE CREATOR"))
        self.label_5.setText(_translate("MainWindow", "ENTER THE NAME OF THE VIDEO WHOSE SUBTITLE YOU WANT"))
        self.pushButton.setText(_translate("MainWindow", "OKAY"))
        self.label_6.setText(_translate("MainWindow", "ENTER THE PATH OF THE VIDEO WHOSE SUBTITLE YOU WANT"))
        self.pushButton_2.setText(_translate("MainWindow", "OKAY"))
        self.pushButton_3.setText(_translate("MainWindow", "CREATE SUBTITLE FILE"))
